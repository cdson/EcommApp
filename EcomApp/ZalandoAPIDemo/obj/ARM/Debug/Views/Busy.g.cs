#pragma checksum "E:\Projects\Github\Github\Anees\EcomApp\EcomApp\ZalandoAPIDemo\Views\Busy.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "D931D5AC521EF81005B497B2BF95A08E"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace ZalandoAPIDemo.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class Busy_obj1_Bindings :
            ...
            IBusy_Bindings
        {
            private global::ZalandoAPIDemo.Views.Busy dataRoot;
            ...
            public void SetDataRoot(global::ZalandoAPIDemo.Views.Busy newDataRoot)
            {
                this.bindingsTracking.ReleaseAllListeners();
            ...
            private void Update_(global::ZalandoAPIDemo.Views.Busy obj, int phase)
            {
            ...
            private class Busy_obj1_BindingsTracking
            {
                ...
                public void DependencyPropertyChanged_IsBusy(global::Windows.UI.Xaml.DependencyObject sender, global::Windows.UI.Xaml.DependencyProperty prop)
                {
                    ...
                    {
                        global::ZalandoAPIDemo.Views.Busy obj = sender as global::ZalandoAPIDemo.Views.Busy;
        if (obj != null)
        {
        ...
        bindings.UpdateFallback_BusyText(DATA_CHANGED);
                ...
                public void UpdateChildListeners_(global::ZalandoAPIDemo.Views.Busy obj)
                {
                    Busy_obj1_Bindings bindings;
                    if(WeakRefToBindingObj.TryGetTarget(out bindings))
                    {
                        ...
                        {
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::ZalandoAPIDemo.Views.Busy.IsBusyProperty, tokenDPC_IsBusy);
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::ZalandoAPIDemo.Views.Busy.BusyTextProperty, tokenDPC_BusyText);
                        }
                        if (obj != null)
                        {
                            bindings.dataRoot = obj;
                            tokenDPC_IsBusy = obj.RegisterPropertyChangedCallback(global::ZalandoAPIDemo.Views.Busy.IsBusyProperty, DependencyPropertyChanged_IsBusy);
                            tokenDPC_BusyText = obj.RegisterPropertyChangedCallback(global::ZalandoAPIDemo.Views.Busy.BusyTextProperty, DependencyPropertyChanged_BusyText);
                        }
                    }
                }
            }
